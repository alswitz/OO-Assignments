...
public class Wraith extends GameObject
{
  ...
  private AudioClip specialMoveAudio = Applet.newAudioClip(getClass().getResource("./wraith_special.wav"));
  private AudioClip noEnergy = Applet.newAudioClip(getClass().getResource("./outOfEnergy.wav"));

  public Wraith(String unitName, int x, int y, int w, int h, int dX, int dY){super(unitName, "./t_wraith.png", x, y, w, h, 0, 0);}
	@Override
